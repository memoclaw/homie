...
SQLite-backed stores for sessions, messages, memories, key-value data, and usage tracking.
...
| `createMemoryStore`  | Scoped memory entries for agent context       |
...
```ts
import { openDatabase, createSessionStore, createMemoryStore } from '@homie/persistence';
